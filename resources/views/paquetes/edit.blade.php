...
@section('title', 'Editar ' . $paquete->nombre . ' - Sistema de Emisoras')
...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0">
                <i class="fas fa-edit me-2"></i>Editar Paquete: {{ $paquete->nombre }}
            </h1>
        ...
        <div class="card shadow">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-edit me-2"></i>Editar Información del Paquete
                </h6>
            </div>
            <div class="card-body">
                <form id="paqueteForm" method="POST" action="{{ route('paquetes.update', $paquete) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" 
                                       ...
                                       id="precio_costo" 
                                       name="precio_costo" 
                                       value="{{ old('precio_costo', $paquete->precio_costo) }}" 
                                       required 
                                       step="0.01" 
                                       min="0"
                                       placeholder="0.00">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   id="cantidad_datos" 
                                   name="cantidad_datos" 
                                   value="{{ old('cantidad_datos', $paquete->cantidad_datos) }}" 
                                   required 
                                   min="0"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('cantidad_minutos', $paquete->cantidad_minutos) }}" 
                                   required 
                                   min="0"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   id="cantidad_sms" 
                                   name="cantidad_sms" 
                                   value="{{ old('cantidad_sms', $paquete->cantidad_sms) }}" 
                                   required 
                                   min="0"
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                      ...
                                      name="descripcion" 
                                      rows="3"
                                      placeholder="Descripción detallada del paquete (opcional)">{{ old('descripcion', $paquete->descripcion) }}</textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-end">
                                <button type="button" class="btn btn-secondary me-2" onclick="window.location.href='{{ route('paquetes.show', $paquete) }}'">
    ...
    <div class="col-lg-4">
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label class="form-label fw-bold">Datos Actuales:</label>
                    <p class="mb-0">{{ $paquete->cantidad_datos }} GB</p>
                </div>
                
                <div class="mb-3">
                    <label class="form-label fw-bold">Minutos Actuales:</label>
                    <p class="mb-0">{{ $paquete->cantidad_minutos }} min</p>
                </div>
                
                <div class="mb-3">
                    <label class="form-label fw-bold">SMS Actuales:</label>
                    <p class="mb-0">{{ $paquete->cantidad_sms }} SMS</p>
                </div>
                
                <div class="mb-3">
                    <label class="form-label fw-bold">Descripción Actual:</label>
            ...
            <div class="card-body">
                <div class="alert alert-warning">
                    ...
                    <ul class="mb-0">
                        ...
                        <li>Los cambios se aplicarán a todas las líneas que usen este paquete</li>
                        <li>Se mantendrán todas las líneas asociadas</li>
                    </ul>
                </div>
                ...
                @if($paquete->lineas->count() > 0)
                    <div class="alert alert-info">
                        ...
                        <p class="mb-0">Este paquete está siendo utilizado por {{ $paquete->lineas->count() }} línea(s). Los cambios afectarán a todas ellas.</p>
                    </div>
                @endif
            </div>
        </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    setTimeout(() => {
                        window.location.href = '{{ route('paquetes.show', $paquete) }}';
                    }, 1500);
                } else {
            ...
            error: function(xhr) {
                if (xhr.status === 422) {
                    ...
                    showNotification('Error al actualizar el paquete', 'error');
                }
            }
        });
    });
